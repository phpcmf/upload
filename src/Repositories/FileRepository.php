...
namespace Cmf\Upload\Repositories;
...
use Cmf\Upload\Commands\Download as DownloadCommand;
use Cmf\Upload\Contracts\UploadAdapter;
use Cmf\Upload\Download;
use Cmf\Upload\Events\File\IsSlugged;
use Cmf\Upload\Exceptions\InvalidUploadException;
use Cmf\Upload\File;
use Cmf\Upload\Validators\UploadValidator;
...
class FileRepository
{
    ...
    public function moveUploadedFileToTemp(UploadedFileInterface $upload): Upload
    {
         ...
         */
        $tempFile = @tempnam($this->path.'/tmp', 'cmf.upload.');
    ...
    {
        $whitelistedClientExtensions = explode(',', $this->settings->get('cmf-upload.whitelistedClientExtensions', ''));
